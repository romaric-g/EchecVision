...
if __name__ == "__main__":
    ...
    # move_ia = chess.Move(chess.square(4, 6), chess.square(4, 4))
    ...
    # print(game.board)
    # print("Les blancs ont bien prit le pion noir : ",
    #       game.board.piece_at(chess.square(4, 4)).color)

    # # [Tour 2 : Noir]
    # move_ia = chess.Move(chess.square(5, 7), chess.square(2, 4))
