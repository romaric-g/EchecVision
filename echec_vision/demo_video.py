...
if __name__ == "__main__":
    ...
    while(cap.isOpened()):
        ...
        if (absolute_moov_time > NS__MIN_ABSOLUTE_MOOV or game.board.turn == chess.BLACK) and relative_fix_time >= NS__MIN_RELATIVE_FIX and chess_plate.is_valide() and long_moov_detected:
            if game.is_player_turn():
                ...
                print("L'IA decide de joué le coup : ", move)
                print("Vous devez reporter le coup sur le plateau !")

            else:

                game.play_from_move(move, chess_plate)
